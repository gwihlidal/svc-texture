        ...
        pub mod schema {
            ...
            impl<'a> Texture<'a> {
                ...
                pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                    ...
                    if let Some(x) = args.artifact {
                        builder.add_artifact(x);
                    }
                ...
                pub fn entry(&self) -> Option<&'a str> {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Texture::VT_ENTRY, None)
                }
                #[inline]
                pub fn artifact(&self) -> Option<Artifact<'a>> {
                    self._tab.get::<flatbuffers::ForwardsUOffset<Artifact<'a>>>(
                        Texture::VT_ARTIFACT,
                        None,
                    )
                }
            ...
            impl<'a: 'b, 'b> TextureBuilder<'a, 'b> {
                ...
                pub fn add_entry(&mut self, entry: flatbuffers::WIPOffset<&'b str>) {
                    self.fbb_
                        .push_slot_always::<flatbuffers::WIPOffset<_>>(Texture::VT_ENTRY, entry);
                }
                #[inline]
                pub fn add_artifact(&mut self, artifact: flatbuffers::WIPOffset<Artifact<'b>>) {
                    self.fbb_
                        .push_slot_always::<flatbuffers::WIPOffset<Artifact>>(
                            Texture::VT_ARTIFACT,
                            artifact,
                        );
                }
